...
import 'package:grow/login_empresa.dart';
import 'package:grow/saibamais.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => const LoginEmpresa()));
                            },
                            style: ElevatedButton.styleFrom(
                              foregroundColor: Colors.white,
                              backgroundColor: const Color(0xFF326D58), // Cor do texto do botão
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const SaibaMais()));
                              },
                              child: const Text(
                                'Saiba Mais',
                                style: TextStyle(
